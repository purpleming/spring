...
public class Test3 {
	...
	void boardInsert() throws Exception {
		File f = new File("C:\\kdigital\\web\\img\\burger.jpg");
		FileInputStream fis = new FileInputStream(f);
		MockMultipartFile file = new MockMultipartFile("file", f.getName(), "multipart/form-daata", fis);
		RequestBuilder req = MockMvcRequestBuilders
				.multipart("/board/index.do")
				.file(file)
				.param("title", "제목테스트")
				.param("content", "내용테스트")
				.param("writer", "작성자테스트")
